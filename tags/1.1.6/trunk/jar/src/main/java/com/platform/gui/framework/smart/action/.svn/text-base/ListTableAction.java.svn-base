...
public abstract class ListTableAction<T> extends AbstractAction{
	...
	*/
     ...
     * @throws Exception
     */
    public IDataColumnDecorate registerDataColumnDecorate() throws Exception{
        return null;
    }
	...
	public void displayData() throws Exception{
		...
		if(recordList != null){
            ...
            request.setAttribute(SmartConstants.DATA_COLUMN_DECORATE , this.registerDataColumnDecorate());
