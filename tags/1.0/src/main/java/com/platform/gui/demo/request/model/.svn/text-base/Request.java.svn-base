...
import com.platform.gui.framework.tags.inter.IEnableAction;
...
public class Request implements IEnableAction , IEnableDecorate{
	...
	public IColumnDecorate getColumnDecorate(String columnName){
		...
		if(columnName.equals("memory")){
			...
			//add link
			decorate = new URLColumnDecorate("./toRequest.action");
		}
		else{
			decorate = ColumnDecorateFactory.getDecorateFromBean(this, columnName);
		}
		return decorate;
	}
}
