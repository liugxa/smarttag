package com.platform.gui.framework.util;

import java.util.Collections;
import java.util.List;

import com.platform.gui.framework.comparator.BeanComparator;
import com.platform.gui.framework.comparator.ComparatorFactory;
import com.platform.gui.framework.comparator.SortException;
...
//	}
	...
	public void sort(List<T> list, String property, SortOrder sortOrder) throws SortException {
		if(list == null || property == null || list.size() == 0) return;
		try{
			BeanComparator comparator = ComparatorFactory.getComparator(list.get(0), property);
