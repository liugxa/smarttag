...
public class SmartListTableTag extends TagSupport {
	...
	public int doStartTag() throws JspException {
		try{
			...
			this.pageContext.setAttribute("resource", this.resource);
	...
	protected SmartTableGridContext getTableGridContext() throws Exception{
		...
		return new SmartTableGridContext(request.getContextPath() , url , dataSize , parameters , configure , locale , resource);
	}
