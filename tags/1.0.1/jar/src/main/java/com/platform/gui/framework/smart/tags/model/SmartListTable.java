...
public class SmartListTable implements IEnableHtml{
	...
	public String getHtml() throws Exception {
		...
		root.put("rows", this.tableGrid.getRows());
		root.put("cells", this.tableGrid.getCells());
		root.put("rowAction", this.tableGrid.getRowAction());
		root.put("pagination", this.tableGrid.getPagination());
