...
public class SmartTableGrid implements IEnableHtml{
	 ...
	 * @param context
	 */
	public SmartTableGrid(SmartTableGridContext context , List<SmartRow> rows , List<SmartCell> cells , SmartRowAction rowAction){
		this.rows = rows;
		this.cells = cells;
	...
	public String getHtml() throws Exception {
		...
		root.put("rows", this.rows);
		root.put("cells", this.cells);
