	...
	*/
	...
	public void removeSessionData(){
		try{
			...
			String page = this.getServletRequest().getParameter(SmartConstants.PARAMS_PAGE);
			String sortBy = this.getServletRequest().getParameter(SmartConstants.PARAMS_SORT_BY);
			String sortOrder = this.getServletRequest().getParameter(SmartConstants.PARAMS_SORT_ORDER);
