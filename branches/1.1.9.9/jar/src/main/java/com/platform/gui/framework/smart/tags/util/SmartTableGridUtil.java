...
public class SmartTableGridUtil {
	...
	public static List<SmartRow> getSmartRowList(PageContext pageContext , SmartTableContext context , IDataRecordList dataRecords  , FilterData filterData) throws Exception{
		...
		if(fd == null){
			...
			Object obj = pageContext.getSession().getAttribute(SmartConstants.FILTER_DATA);
