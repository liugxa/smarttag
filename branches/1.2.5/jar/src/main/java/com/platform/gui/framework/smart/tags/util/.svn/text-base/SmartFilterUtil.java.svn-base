...
public class SmartFilterUtil {
	 ...
	 * @throws Exception
	 */
	public static SmartFilter getSmartFilter(PageContext pageContext , SmartTableContext context , IDataItem dataItem , IDataItemDecorate itemDecorate) throws Exception{
		SmartFilter filter = null;
		if(dataItem != null){
			List<SmartSection> sections = getSmartSectionList(pageContext , dataItem , itemDecorate);
	 ...
	 * @throws Exception
	 */
	public static List<SmartSection> getSmartSectionList(PageContext _pageContext , IDataItem _dataItem , IDataItemDecorate _itemDecorate) throws Exception{
