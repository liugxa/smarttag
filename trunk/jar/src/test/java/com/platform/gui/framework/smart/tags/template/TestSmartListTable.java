...
public class TestSmartListTable extends TestCase{
	...
	public void testSmartFilter(){
		try{
			...
			SmartFilter filter = new SmartFilter(context , this.getSmartSections(context));
	...
	private List<SmartSection> getSmartSections(MockSmartTableGridContext context) throws Exception{
