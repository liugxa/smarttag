...
<div id="" class="filterBaseArea">
	<!--Filter Begin-->
	<div class="filterRange">
		<!--Position is absolute Begin-->
		<div class="filterEntranceClose">
			<a class="close" onClick="st_filter_display('${context.name}', this);return false;" href="javascript:;">
				<#if filter.label??>
...
<div id="st_filter_result_${context.name}" class="filterSettingInfo">
